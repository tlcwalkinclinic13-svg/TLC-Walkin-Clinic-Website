...
const translations = {
  en: {
    ...
    'footer.sms_privacy': 'SMS Privacy Policy',
    ...
    // SMS Privacy Policy Page
    'sms.title': 'SMS Privacy Policy',
    'sms.subtitle': 'Information regarding our text messaging communications and patient privacy protection.',
    'sms.comm.title': 'SMS Communications',
    'sms.comm.p1': 'By providing your mobile phone number to TLC Walk-In Clinic, you consent to receive SMS messages related to your care and our services. These messages may include, but are not limited to:',
    'sms.comm.item1': 'Appointment reminders and confirmations',
    'sms.comm.item2': 'Follow-up communications',
    'sms.comm.item3': 'Billing or account notifications',
    'sms.comm.item4': 'Clinic announcements',
    'sms.comm.item5': 'Other healthcare-related information',
    'sms.comm.freq': 'Message frequency may vary.',
    'sms.opt.title': 'Opting Out and Assistance',
    'sms.opt.p1': 'You may opt out of receiving text messages at any time by replying STOP to any message. After you send STOP, you will no longer receive SMS messages from us unless you opt in again.',
    'sms.opt.p2': 'Reply HELP for more information.',
    'sms.rates.title': 'Message and Data Rates',
    'sms.rates.p1': 'Message and data rates may apply based on your wireless carrier\'s plan.',
    'sms.privacy.title': 'Privacy of Your Information',
    'sms.privacy.p1': 'TLC Walk-In Clinic respects your privacy. Your personal information, including your mobile phone number and your consent to receive SMS messages, will be used solely to communicate with you regarding our services.',
    'sms.privacy.p2': 'Your mobile phone number and your consent to receive text messages will never be shared, sold, or disclosed to third parties or affiliates for marketing or promotional purposes. We only share your information with service providers when necessary to deliver the text messaging services you have requested.',
    'sms.contact.title': 'Questions & Contact',
    'sms.contact.p1': 'If you have any questions regarding our SMS communications or this Privacy Policy, please contact TLC Walk-In Clinic directly.',

    // Home Page Alert
    'home.sms_alert.badge': 'Policy Notice',
    'home.sms_alert.title': 'New Page: SMS Privacy Policy',
    'home.sms_alert.desc': 'Learn how TLC Walk-In Clinic uses SMS text messaging for appointments and care updates, and review our strict privacy protections.',
    'home.sms_alert.btn': 'View SMS Privacy Policy',
  },
  es: {
    // Ticker
    ...
    'footer.sms_privacy': 'Política de Privacidad de SMS',
    ...
    // SMS Privacy Policy Page
    'sms.title': 'Política de Privacidad de SMS',
    'sms.subtitle': 'Información sobre nuestras comunicaciones por mensajes de texto y la protección de la privacidad del paciente.',
    'sms.comm.title': 'Comunicaciones por SMS',
    'sms.comm.p1': 'Al proporcionar su número de teléfono móvil a TLC Walk-In Clinic, usted da su consentimiento para recibir mensajes SMS relacionados con su atención médica y nuestros servicios. Estos mensajes pueden incluir, entre otros:',
    'sms.comm.item1': 'Recordatorios y confirmaciones de citas',
    'sms.comm.item2': 'Comunicaciones de seguimiento',
    'sms.comm.item3': 'Notificaciones de facturación o de cuenta',
    'sms.comm.item4': 'Anuncios de la clínica',
    'sms.comm.item5': 'Otra información relacionada con la atención médica',
    'sms.comm.freq': 'La frecuencia de los mensajes puede variar.',
    'sms.opt.title': 'Cancelación y Asistencia',
    'sms.opt.p1': 'Puede optar por no recibir mensajes de texto en cualquier momento respondiendo STOP a cualquier mensaje. Después de enviar STOP, ya no recibirá mensajes SMS nuestros a menos que vuelva a optar por recibirlos.',
    'sms.opt.p2': 'Responda HELP para obtener más información.',
    'sms.rates.title': 'Tarifas de Mensajes y Datos',
    'sms.rates.p1': 'Pueden aplicarse tarifas de mensajes y datos según el plan de su operador de telefonía móvil.',
    'sms.privacy.title': 'Privacidad de su Información',
    'sms.privacy.p1': 'TLC Walk-In Clinic respeta su privacidad. Su información personal, incluido su número de teléfono móvil y su consentimiento para recibir mensajes SMS, se utilizará exclusivamente para comunicarse con usted con respecto a nuestros servicios.',
    'sms.privacy.p2': 'Su número de teléfono móvil y su consentimiento para recibir mensajes de texto nunca se compartirán, venderán ni divulgarán a terceros o afiliados con fines de marketing o promoción. Solo compartimos su información con proveedores de servicios cuando sea necesario para brindar los servicios de mensajería de texto que ha solicitado.',
    'sms.contact.title': 'Preguntas y Contacto',
    'sms.contact.p1': 'Si tiene alguna pregunta sobre nuestras comunicaciones por SMS o esta Política de Privacidad, comuníquese directamente con TLC Walk-In Clinic.',

    // Home Page Alert
    'home.sms_alert.badge': 'Aviso de Política',
    'home.sms_alert.title': 'Nueva Página: Política de Privacidad de SMS',
    'home.sms_alert.desc': 'Conozca cómo TLC Walk-In Clinic utiliza los mensajes de texto SMS para citas y actualizaciones de atención médica, y revise nuestras estrictas protecciones de privacidad.',
    'home.sms_alert.btn': 'Ver Política de Privacidad de SMS',
  }
};
